...
export function AgentFunctions() {
  ...
  return <section className="supportable-admin">
    ...
    <div className="admin-create-row">
      <div className="admin-create-field"><label htmlFor="agent-function-name">Name</label><input id="agent-function-name" value={newName} onChange={(event) => setNewName(event.target.value)} placeholder="e.g. browser.navigate" /></div>
      <div className="admin-create-field"><label htmlFor="agent-function-description">Description</label><input id="agent-function-description" value={newDescription} onChange={(event) => setNewDescription(event.target.value)} /></div>
      <div className="admin-create-actions"><button className="primary-button" type="button" onClick={() => void saveFunction()} disabled={saving || !newName.trim()}>Save</button></div>
    </div>
