...
export default function App() {
  ...
  return <div className={`console theme-${theme}`}>
    ...
    <main className="app-container">{!authenticated ? <section className="welcome-view"><div className="app-kicker">eBliss Console</div><h1>Welcome.</h1><p className="app-lead">Sign in to begin.</p><button className="primary-button welcome-login" onClick={() => setLoginOpen(true)}><LogIn size={17} />Login</button></section> : activeApp === 'Supportable' && <Supportable />}</main>
